...
export HINTS_EXPERIMENT_ID="E09M"
...
for seed in "${seeds[@]}"; do
  ...
  export HINTS_PREDICTION_FILE="mtl_s75_a50_predictions_$seed.csv"
  export HINTS_TRAIN_FILE="D_s75_a50_train_$seed.csv"
  export HINTS_VALIDATION_FILE="D_s75_a50_val_$seed.csv"
  export HINTS_TEST_FILE="T_s50_a50_test_$seed.csv"
  export HINTS_MODEL_WEIGHTS_FILE="mtl_s75_a50_weights_$seed"
  export HINTS_MODEL_HISTORY_FILE="mtl_s75_a50_acc_and_loss_$seed.csv"
  export HINTS_MODEL_PERFORMANCE_FILE="mtl_s75_a50_performance_$seed.csv"
