...
export HINTS_EXPERIMENT_ID="E01"
...
for seed in "${seeds[@]}"; do
  ...
  export HINTS_PREDICTION_FILE="stl_s50_a50_predictions_$seed.csv"
  ...
  export HINTS_MODEL_WEIGHTS_FILE="stl_s50_a50_weights_$seed"
  export HINTS_MODEL_HISTORY_FILE="stl_s50_a50_acc_and_loss_$seed.csv"
  export HINTS_MODEL_PERFORMANCE_FILE="stl_s50_a50_performance_$seed.csv"
