...
export HINTS_EXPERIMENT_ID="E09BR"
...
for seed in "${seeds[@]}"; do
  ...
  export HINTS_PREDICTION_FILE="br_s75_a50_predictions_$seed.csv"
  ...
  export HINTS_MODEL_WEIGHTS_FILE="br_s75_a50_weights_$seed"
  export HINTS_MODEL_HISTORY_FILE="br_s75_a50_acc_and_loss_$seed.csv"
  export HINTS_MODEL_PERFORMANCE_FILE="br_s75_a50_performance_$seed.csv"
