...
export HINTS_EXPERIMENT_ID="E01BR"
...
for seed in "${seeds[@]}"; do
  ...
  export HINTS_MODEL_WEIGHTS_FILE="br_s50_a50_weights_$seed"
  export HINTS_MODEL_HISTORY_FILE="br_s50_a50_acc_and_loss_$seed.csv"
