...
class MTLStrengthenModel(base_model.BaseModel):
    ...
    def build_model(self):
        ...
        self.model.compile(
            ...
            loss={'out_class': 'binary_crossentropy', 'out_demographic': 'binary_crossentropy'},
    ...
    def fit_model(self):
        early_stopping = EarlyStopping(monitor='val_out_class_accuracy', patience=10, verbose=1)
