...
BEST_MODEL_PATH = '/home/user_name/git_repositories/multi-task-BR-net/2_pipeline/best-model'
LAST_MODEL_PATH = '/home/user_name/git_repositories/multi-task-BR-net/2_pipeline/last-model'
METRICS_PATH = '/home/user_name/git_repositories/multi-task-BR-net/2_pipeline/metrics'
RESULTS_PATH = '/home/user_name/git_repositories/multi-task-BR-net/2_pipeline/results'
# ----------- CONFIGURATION --------------------------------------------------#
...
datasets = {
    ...
    'train_ctrl': CSVDatasetWithAllLabels(train_root, train_csv, 'isic_id', 'target',
                                        transform=augs.tf_transform, add_extension='.JPG',
                                        random_subset_size=limit_data, remove_unknowns=True,ctrl=False,age_thr=60),
