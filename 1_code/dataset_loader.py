...
class CSVDataset(data.Dataset):
    def __init__(self, root, csv_file, image_field, target_field,
                 ...
                 age_field = "age_approx", sex_field="sex",remove_unknowns=True,
                 age_thr=60,ctrl=False):
        """
        :param root:
        :param csv_file:
        :param image_field:
       ...
       :param age_thr: the threshold for young/old criteria
...
class CSVDatasetWithMeta(CSVDataset):
    ...
    def __getitem__(self, i,age_thr=60):
        """
        Returns:
            tuple(tuple(PIL image, int), str): a tuple
            containing another tuple with an image and
